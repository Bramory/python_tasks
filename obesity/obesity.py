...
def do_calculus():
    ...
    set_process(cur_weight)

def set_process(cur_weight):
    global PROCESS
    global ideal_weight
...
if True:
    ...
    gramms = -1
    try:
        gramms = (start_weight - cur_weight) / days * 1000
    except:
        print (' Num of days ====== 0 ')

    print (' You were drop', round(gramms, 0), 'gramms each day')
    print (' Average calories deficit =', round(sum(calories_deficit) / len(calories_deficit), 0), 'ccal/day')
